...
export default function LoginPage({ onSignIn, onSignInWithEmail, error }: Props) {
        ...
        <div className="glass-card p-10 text-center">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3 mb-4 text-left">
            <input
              ...
              autoComplete="email"
              className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6C63FF]/30 focus:border-[#6C63FF]/50"
            />
            <input
              type="password"
              placeholder="비밀번호"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl
              ...
              transition-all active:scale-[0.98] text-sm font-semibold text-gray-700"
          >
