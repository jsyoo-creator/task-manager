      ...
      <div style={{ maxWidth: 1040, margin: '0 auto', padding: '0 24px 120px' }}>
        ...
        <div style={{ display: 'flex', gap: 40, alignItems: 'flex-start' }}>
          ...
          <section>
            ...
            <P>
              이 프로젝트도 실제로는 <b>"~해줘"를 던지고 끝나는 방식이 아니었습니다.</b> 어떤 상황이라 왜 필요한지 설명하고,
              방향이 여러 개일 수 있는 부분은 클로드에게 의견을 묻고, 제안받은 방향이 맞는지 확인한 뒤에 진행하는 <b>대화에 가까웠습니다.</b>
            ...
            <Callout tone="tip" title="명령보다 '설명 + 상의'가 더 잘 통합니다">
              방향이 명확한 아주 작은 요청("이 오타 고쳐줘")은 바로 실행을 부탁해도 됩니다. 하지만 화면 구조나 데이터가 걸린 결정은,
              <b>왜 필요한지 배경을 먼저 설명하고</b> "이렇게 하면 어떨까?", "이 중 어떤 방식이 나을까?"처럼 <b>의견을 물어본 뒤</b> 방향을 맞추고 진행하는 편이
              헛수고를 훨씬 줄여줍니다. 실제로 이 프로젝트의 큰 변경들은 대부분 이런 상의 과정을 거쳤습니다(6번 소통 오류 사례 참고).
            </Callout>
          </section>
